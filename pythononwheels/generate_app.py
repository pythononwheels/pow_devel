...
def rename_extensions(folder, old_ext, new_ext, files=None):
    ...
    for filename in os.listdir(folder):
        ...
        if not os.path.isfile(infilename): continue{% extends "base.spc" %}
          ...
          <div class="text-center">
            ...
            <div>
              ...
              <p>
                ...
                <a class="github-button" href="https://github.com/pythononwheels/pow_devel/issues" data-icon="octicon-issue-opened" data-show-count="true" aria-label="Issue pythononwheels/pow_devel on GitHub">Issue</a>
              </p>
            </div>
          </div>
      <div class="column col-2">
