...
def main():
	...
	if options.model == "None":
		...
		controller_model = options.model
	
	renderController(controller_name, controller_model, options.noforce)
			
	
def renderController(name,model,noforce):
	# 
	print "creating controller: " + name + "  for model: " + model
	...
	ostr += powlib.linesep
	ostr += "import " + string.capitalize( model ) 
	ostr += powlib.linesep
	ostr += powlib.linesep
	
	classname = string.capitalize( model ) + "Controller"
	...
	ostr = ostr + infile.read()
	ostr+= powlib.tab + powlib.tab + "self.modelname = \"" + string.capitalize( model ) + "\"" + powlib.linesep
